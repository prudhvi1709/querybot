...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Add list files button next to load file button
  // const filePathInput = DOM.filePathInput();
  // if (filePathInput && filePathInput.parentElement) {
  //   filePathInput.parentElement.innerHTML += `
  //   <button class="btn btn-outline-secondary" id="listFilesButton">
